...
function sgsd {
    ...
    if (`$Help) {
        ...
        Write-Host '  sgsd -Bootstrap      Create minimal .planning/memory in place'
        Write-Host '  sgsd -Backfill       Full SGSD .planning scaffold for existing project'
        Write-Host '  sgsd -Claude         Also launch Claude Code (per-session --dangerously-skip-permissions)'
