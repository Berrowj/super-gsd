...
$projectRoot = 'C:\Users\jack.berrow\Voice-Text-Plan'
$installer   = Join-Path $projectRoot 'super-gsd\scripts\install-vtp-remote-services.ps1'
$nssmPath    = 'C:\Users\jack.berrow\AppData\Local\Microsoft\WinGet\Packages\NSSM.NSSM_Microsoft.Winget.Source_8wekyb3d8bbwe\nssm-2.24-101-g897c7ad\win64\nssm.exe'
