...
// Phase 67-01 self-test entry. Operator-friendly shell that delegates to
...
//
// EXIT CODE
//   - 0  -> check.cjs --self-test all-PASS (12-15/12-15 green)
//   - 1  -> any FAIL in the self-test bootstrap suite
//   - any other non-zero -> propagated verbatim
//
// Mirrors super-gsd/tools/upgrade-drift/run-self-test.cjs (Phase 62 pattern).
// ASCII-only.
// =============================================================================
