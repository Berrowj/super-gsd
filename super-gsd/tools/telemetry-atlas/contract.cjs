...
const SHAPES = Object.freeze({
  ...
  scope: fields('launcher_repo_id coordination_id association event_cwd_repo_id target_repo_id target_repo_source target_repo_confidence milestone phase plan task gate role cost_center attribution_method'),
