...
- **`gsd-codebase-mapper` + `gsd-plan-checker` VTP hooks.** Listed in canonical_refs as lower-priority targets. Could land in Phase 16 or defer to 16.1/16.2 depending on plan-phase scoping. Planner to decide.
