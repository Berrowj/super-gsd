...
DEVIATIONS / None; native statusLine and Git pre-commit surfaces are explicitly preserved.

BLOCKERS / None.

ONE_LINER / Three red-first tasks cover extension-complete distribution, manifest-driven registration completeness, and real Clarity-shaped `sgsd-update` recovery.
