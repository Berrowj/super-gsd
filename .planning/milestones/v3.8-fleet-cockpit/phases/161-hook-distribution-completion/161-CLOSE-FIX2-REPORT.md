...
DEVIATIONS / Dynamic recovery re-smoke unavailable: sandbox blocks Node child processes with `EPERM`.

BLOCKERS / Unsandboxed Git/Bash run required for exit-0 evidence.

ONE_LINER / Recovery now seeds scripts/lib, registry, and VTP runtime; production files untouched.
