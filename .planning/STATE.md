...
status: "v3.4 P142 PENDING — alarm drawer + rationale drawer + per-section localStorage collapse persistence + 5-sec test conformance gate; cockpit live at http://localhost:7777/"
