...
milestone_status: "v3.4 ACTIVE 2026-05-24 — Operator Cockpit IA Rewrite. P136 PASS @ 698efdf (light palette + IA scaffold + liveness DOM hooks; 63/63). P137 PASS (this commit) (14-key data contract + cockpit-sources.yaml + liveness.cjs + R19 binding gate; 71/71). 10 binding invariants locked incl. #10 liveness contract. About to scaffold P138 (sticky chrome + SSE keep-alive + reconnect badge)."
status: "v3.4 P138 PENDING — sticky chrome (CommandStrip/ScanBar/ExplanationBand/sec-nav) + SSE keep-alive 15s ping + EventSource reconnect badge filling data-conn=state placeholder"
