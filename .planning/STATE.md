...
milestone_status: "v3.4 ACTIVE 2026-05-24 — Operator Cockpit IA Rewrite. P136 PASS 2026-05-24 @ 698efdf (light palette + IA scaffold renderShell + 7 section IDs + liveness DOM hooks; 63/63 self-test). 10 binding invariants locked incl. #10 liveness contract. v3.3 closed prior. About to scaffold P137 (snapshot data contract + Cockpit Source Registry + liveness heartbeat)."
status: "v3.4 P137 PENDING — snapshot data contract expansion (~14 keys) + cockpit-sources.yaml + per-source heartbeat + gate.liveness.all-sources-fresh"
