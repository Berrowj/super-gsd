...
milestone_status: "v3.4 ACTIVE 2026-05-24 — Operator Cockpit IA Rewrite scoped 8 phases (P136-P143). 10 binding invariants locked incl. #10 liveness contract (Cockpit Source Registry + per-source heartbeat + staleness pills + SSE keep-alive + EventSource auto-reconnect + gate.liveness.all-sources-fresh). v3.3 ALL-PHASES-CLOSED 2026-05-24 — 7 PASS + 1 PASS-WITH-DEFERRED-IMPLEMENTATION-TO-v3.4 (P135 pivoted to Claude Design IA-rewrite pack at .planning/milestones/v3.4/design-pack/). Cockpit self-test 57/57. About to scaffold P136 (design tokens + IA scaffold)."
status: "v3.4 P136 PENDING — design tokens + IA scaffold; v3.3 closed; v3.4 INTENT.md authored with liveness contract"
