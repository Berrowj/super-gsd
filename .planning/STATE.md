...
progress:
  ...
  v3_9:
    ...
    completed_plans: 1
    percent: 50
    phase_167: "IN-PROGRESS 2026-08-23 — T1 witness hook/broker/store, T2 witness-correlated acceptance, T3 four-surface fail-closed prompts, T4 propagation with invocation-bound broker authority; T5 live proof pending"
backlog:
  total_unresolved: 10
  by_kind:
    verifier_fail: 0
