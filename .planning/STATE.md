...
milestone_status: "v3.0 ACTIVE 2026-05-20 — P106 PASS @ 390ef1a (CMB schema + 17 fixtures; 14/14 schema self-tests; DLB-08.1 contract shipped). P107 ACTIVE — cmb-validate.cjs + cmb-hash.cjs + execution_receipt + review_finding writers (DLB-08.2+.3). DLB-08 Mesh Memory Lite design-locked @ 52c687a; 7-phase roadmap P106-112 across DLB-08/-09/-10. Four-fixture exit criteria locked (A false-CRIT refuted no operator wake / B context-aware pseudo-op rec / C lineage chain end-to-end / D production-mutation forces escalation). v2.9 ALL-PHASES-CLOSED 2026-05-18 (9/9 phases incl. P97.5 DLB-07 protection plan). v2.2-v2.8 35/35. Hard constraints: no Pi-harness (Anthropic OAuth ToS), no sym-mesh-channel critical-path, single Windows 11 box (logical peers + sequential runtime), no executor-authored CMBs in MVP, hard operator carve-outs for production/security/scope/credentials/<0.70-confidence."
status: "v3.0 ACTIVE — P106 PASS @ 390ef1a; P107 cmb-validate + cmb-hash + writers queued for Codex PLAN authoring"
...
progress:
  v3_0:
    ...
    completed_plans: 1
    percent: 14
    phase_106: "PASS ✓ 2026-05-20 @ 390ef1a (Mesh CMB Schema and Canonical Hashing; DLB-08.1; cmb.schema.json + 17 fixtures; 14/14 schema self-tests green; SCHEMA-MML-02/-03 ajv-errors fire correctly; 6 SACs declared in PLAN run at P107 close)"
    phase_107: "ACTIVE — execution_receipt + review_finding emission writers + cmb-validate.cjs + cmb-hash.cjs (DLB-08.2+.3)"
    phase_108: "PENDING — evidence_validator (Tier 0+1) + lineage DAG + echo detector (DLB-08.4+.5)"
    phase_109: "PENDING — pseudo_operator peer + escalation gate w/ hard carve-outs (DLB-08.6+.7)"
