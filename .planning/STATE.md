...
status: "v3.5 ACTIVE 2026-08-05 — Always-On Orchestration opened at operator instruction after /sgsd-triage run (design spec operator-approved: classifier-gated cross-model triage, board-line gate posture, interactive codex trust). Phases 144-150 scaffolded with CONTEXT.md seeds; P144 (chronicle handover automation) carried in with superseded ACs noted. Next: /sgsd-orchestrate readiness audit then P145 codex-profile-control. v3.4 PARKED at P142/P143 (cockpit alarm+rationale drawers, close) — reopen after v3.5 or on operator call. v3.4 P999 pink-elephant visual smoke also parked."
