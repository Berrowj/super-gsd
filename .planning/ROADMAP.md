...
- ✅ **v1.6 Cockpit 2.0 + Startup Verification** — Phases 26-30 (shipped 2026-04-27 as SHIPPED-WITH-DEBT-18 under full-roadmap autopilot run #2) — [summary](milestones/v1.6/SUMMARY.md) · [requirements](milestones/v1.6/REQUIREMENTS.md) · controlling contract: [ROADMAP-AGENT.md](ROADMAP-AGENT.md)
